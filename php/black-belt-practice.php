<?php
/*
	Template Name: Black Belt Practice Template
*/
?>
	<?php get_header(); ?>
				...
				<div class="inner-content">
					<div class="content-no-sidebar">
						<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
							...
							$json_url = get_stylesheet_directory_uri() . '/data/black_belt_techniques.json';
							...
							function displayFlashcards($json) {
								...
								foreach ($flashcards as $card) {
									...
									if (!empty($card['image_url'])) {
										echo '<img src="' . esc_url($card['image_url']) . '" alt="' . esc_attr($card['Title']) . '" style="max-width: 100%; height: auto;">'; // Added basic inline style for responsiveness
									}
									echo '<div class="meta">';
